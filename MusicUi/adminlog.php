...
$result=mysql_query("SELECT username,password FROM admin WHERE username='$username' AND password='$password' LIMIT 1");
...
header('Location:http://localhost/MusicUi/Adminpage.php');
}
else 
{
